                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                                    <div class="profile-name">
                                                        <h4 class="text-primary">Ikhwal Ardiansah</h4>
                                                        <p>UX / UI Designer</p>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                                    <div class="profile-email">
                                                        <h4 class="text-muted">ikhwalardiansyah07@gmail.com</h4>
                                                        <p>Email</p>
                                                    </div>
                                                </div>
                            ...
                            <div class="card-body">
                                <div class="profile-statistics">
                                    <div class="text-center mt-4 border-bottom-1 pb-3">
                                        <div class="row">
                                            <div class="col">
                                                <h3 class="m-b-0">7.85T</h3><span>Follower</span>
                                            </div>
                                            <div class="col">
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-9"><span>Ikhwal Ardiansah</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-9"><span>ikhwalardiansyah07@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-9"><span>Tokio</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
