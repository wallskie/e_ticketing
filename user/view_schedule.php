					...
					<div class="row align-items-center">
						...
						<div class="col-md-10 text-right menu-1">
							<ul class="nav-list">
								...
								<li><a href="view_schedule.php" class="active"><i class="fas fa-calendar-alt"></i> Schedule</a></li>
										...
										<tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><center><?php echo $schedule['train_code']; ?></center></td>
                                                    <td><center><?php echo $schedule['destination_name']; ?></center></td>
                                                    <td><center><?php echo $schedule['departure_day']; ?></center></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
									</table>
