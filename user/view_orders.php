					...
					<div class="row align-items-center">
						...
						<div class="col-md-10 text-right menu-1">
							<ul class="nav-list">
								...
								<li><a href="view_orders.php" class="active"><i class="fas fa-exchange-alt"></i> Transaction</a></li>
								...
								<div class="table-responsive">
									<table class="table">
										<thead class="thead-primary">
											<tr>
												<th scope="col"><center>ID Pemesanan</center></th>
												<th scope="col"><center>Tujuan</center></th>
                                                <th scope="col"><center>Tanggal Pemesanan</center></th>
										...
										<tbody>
                                            <?php while ($order = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    <td><center><?php echo $order['id']; ?></center></td>
                                                    <td><center><?php echo $order['destination_id']; // Anda bisa mengganti dengan nama tujuan jika ada ?></center></td>
                                                    <td><center><?php echo $order['departure_day']; ?></center></td>
                                                    <td><center><?php echo $order['status']; ?></center></td>
                                                    <td><center>Rp<?php echo number_format($order['total_harga'], 2, ',', '.'); ?></center></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
									</table>
